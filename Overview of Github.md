In this video, you will get an overview of Git and GitHub, which are popular environments among developers and data scientists for performing version control of source code files and projects and collaborating with others. 
...
**Git** is free and open-source software distributed under the new General Public License. 
...
* You can use Git without a web interface by using your command-line interface, 



but **GitHub** is one of the most popular web-hosted services for *Git repositories*. 
...
* When starting out with a new repository, you only need create it once, either locally and then push to GitHub or by cloning an existing repository by using the command git clone. 
...
To learn how to use Git effectively and begin collaborating with data scientists around the world, you will need to learn the essential commands. 



Luckily for us, GitHub has amazing resources available to help you get started. 

Go to try.github.io to download the cheat sheets and run through the tutorials. In the following modules, we'll give you a crash course on setting up your local environment and getting started on a project.
